		...
		<div className="product-admin">
			...
			<div className="type_product">
				<div className="type_product_search">
					<Button variant="success" onClick={themMauSac}>
						Thêm màu sắc
					</Button>
					<div className="search-thuonghieu">
						<label>Tìm kiếm</label>
						<input type="text" value={searchMS} placeholder="Nhập tên Màu sắc" onChange={searchMauSac} />
					</div>
				</div>
										...
										<tr key={index + 1}>
											...
											<td className="Controls_type">
												<Button
													...
													onClick={() => onupdateMauSac(post)}
												>
													sửa
												</Button>
												<Button
													variant="danger delete_type"
													onClick={() => ondeleteMauSac(post)}
												>
													Xóa
												</Button>
											</td>
