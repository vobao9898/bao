...
import { AssignmentTurnedIn, AddShoppingCart, PersonAdd, ListAlt } from '@material-ui/icons';
		...
		<div className="homePage-admin">
			<div className="homepage">
				...
				<div className="category-homePage">
					...
					<div className="bill-homePage shadow">
						<div className="vertical">
							<div className="base">
								<div className="left">
									<div className="title-homePage-small"> Số hoá đơn chưa xử lí </div>
									<div className="amount-homePage"> 1 </div>
								</div>
								<div className="righ">
				...
				<div className="statistical-homepage">
					<div className="title-statistical-homepage"> Thông kê số lượng đơn hàng </div>
				</div>
			</div>
		</div>
	);
